...
function ChartTooltipContent({
  ...
  React.ComponentProps<"div"> & {
    ...
    nameKey?: string
    labelKey?: string
    payload?: Array<{ dataKey: string; name?: string; value: unknown; payload: unknown; color?: string; fill?: string }>
    label?: string
    labelFormatter?: (value: unknown, payload?: unknown) => string
    labelClassName?: string
    formatter?: (value: unknown, name?: unknown, item?: unknown, index?: number, payload?: unknown) => string
    color?: string
  }) {
